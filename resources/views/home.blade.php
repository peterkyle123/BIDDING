    ...
    <div class="flex items-center space-x-4 w-full md:w-auto justify-center md:justify-end">
      <div class="relative w-full md:w-64">
        ...
        <input type="text" placeholder="Search..." 
          class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-bid-green outline-none">
      </div>
...
<main class="p-6">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
    ...
    <a href="{{ route('lgus.index') }}" 
       class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-all flex justify-between items-center group">
      <div>
        <p class="text-sm font-medium text-gray-600">Entities</p>
        <p class="text-3xl font-bold text-gray-900 mt-2">{{ \App\Models\LGU::count() }}</p>
      </div>
      <div class="w-12 h-12 bg-bid-green bg-opacity-10 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform">
    ...
    <a href="{{ route('documents.index') }}" 
      ...
      <div>
        ...
        <p class="text-3xl font-bold text-gray-900 mt-2">{{ \App\Models\Document::count() }}</p>
      </div>
      <div class="w-12 h-12 bg-bid-orange bg-opacity-10 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform">
